...
var badMemories = null;
console.log(badMemories);
console.log(typeof null);  //its a bug of js its typeof IS NULL ONLY.
...
const myString0 = "42";
const myNumber0 = parseInt(myString0);
console.log(myNumber0); // Output: 42
